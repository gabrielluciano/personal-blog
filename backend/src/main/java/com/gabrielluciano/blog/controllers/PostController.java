...
public class PostController {
    ...
    public ResponseEntity<Page<PostResponse>> list(Pageable pageable, String title, boolean drafts) {
        return ResponseEntity.ok(postService.list(pageable, title, drafts));
    }
